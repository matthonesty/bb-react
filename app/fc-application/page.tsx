      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Apply to become a Fleet Commander for Bombers Bar</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-foreground mb-2"
                >
                  Why do you want to become an FC for Bombers Bar?{' '}
