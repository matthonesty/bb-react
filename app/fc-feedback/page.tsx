        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-center text-foreground-muted">
              Please log in to submit FC feedback.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Provide anonymous feedback about a fleet experience
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <label htmlFor="fleet_date" className="block text-sm font-medium text-foreground mb-2">
              ...
              <div>
                <label htmlFor="fleet_time" className="block text-sm font-medium text-foreground mb-2">
              ...
              <div>
                <label htmlFor="fleet_length" className="block text-sm font-medium text-foreground mb-2">
                  Fleet Length
                </label>
                <select
                  id="fleet_length"
            ...
            {/* Fleet Type */}
            <div>
              <label htmlFor="fleet_type" className="block text-sm font-medium text-foreground mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="fc_rating" className="block text-sm font-medium text-foreground mb-2">
              ...
              <div>
                <label htmlFor="had_fun" className="block text-sm font-medium text-foreground mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="was_clear" className="block text-sm font-medium text-foreground mb-2">
            ...
            <div>
              <label htmlFor="clarity_improvement" className="block text-sm font-medium text-foreground mb-2">
            ...
            <div>
              <label htmlFor="fc_improvement" className="block text-sm font-medium text-foreground mb-2">
            ...
            <div>
              <label htmlFor="defining_moment" className="block text-sm font-medium text-foreground mb-2">
            ...
            <div>
              <label htmlFor="additional_comments" className="block text-sm font-medium text-foreground mb-2">
